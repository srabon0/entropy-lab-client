...
const Addreview = () => {
  ...
  <div class="card-body">
  {
      ...
      <div class="w-full mt-4">
                ...
                <textarea name="review" class="block w-full h-40 px-4 py-2 text-gray-700 bg-white border rounded-md  focus:border-blue-400 dark:focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40"></textarea>
            </div>
