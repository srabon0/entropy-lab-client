...
const Signup = () => {
    ...
    const [
      ...
      loading,
      error,
    ] = useCreateUserWithEmailAndPassword(auth); //{sendEmailVerification:true} if you want you can put it inside braces
    const {
      register,
      handleSubmit,
      watch,
...
{signUpError}
            <div className="mt-8">
              <input
                type="submit"
                value="Sign Up"
                className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform hover:btn-secondary  focus:outline-none btn btn-primary"
              />
            </div>
