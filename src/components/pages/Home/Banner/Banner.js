    ...
    <div className="hero min-h-screen bg-base-100">
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div className="md:w-2/4">
          <h1 className="text-5xl font-bold text-primary">Welcome To EntropyLab</h1>
          <p className="py-6">
          ...
          <Link onClick={handleClick} className="btn btn-primary hover:btn-secondary"  to='products' smooth={true} duration={500}>
            Get Started
          </Link>
        </div>
      </div>
